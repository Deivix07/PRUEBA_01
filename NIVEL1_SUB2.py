...
def ventana_tip_palabras():
    ...
    tk.Label(tip_palabras, text="Tipos de palabras: sustantivos, verbos y más", font=("Times", 14, "bold"), bg="steel blue").pack(pady=10)
    tk.Label(tip_palabras, text="\nSelecciona una opción para comenzar:\n", font=("arial", 10, "bold"), bg="steel blue").pack(pady=10)
...
1) Que tiene facilidad para aprender y comprender.
2) Levantar o fabricar una estructura.
3) Gran extensión de agua salada.
4) Que siente o muestra alegría.
5) Elevación natural del terreno."""

vertical = """-----Pistas Verticales----
A) Preparar alimentos para comer.
B) Que se mueve o actúa con gran velocidad.
C) De gran estatura o altura.
D) Cuerpo celeste que brilla en el cielo nocturno.
E) Conjunto de edificios y calles donde habita una gran cantidad de personas.
F) Estar en estado de reposo durante el cual se suspende la actividad consciente.
G) Interpretar letras y palabras escritas."""
